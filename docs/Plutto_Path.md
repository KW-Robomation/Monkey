...
Plutto Path는 이러한 비효율성을 해소하고 하드웨어 통신의 속도와 메모리 효율성을 극대화하기 위해 도입되었으며, 모든 명령을 1바이트 크기의 배열로 압축하는 것이 핵심입니다.
...
Plutto Path는 **1바이트** 크기의 숫자를 원소로 하는 **1차원 배열**의 자료형입니다. 배열의 각 원소는 다음 두 가지 정보를 담고 있습니다.
